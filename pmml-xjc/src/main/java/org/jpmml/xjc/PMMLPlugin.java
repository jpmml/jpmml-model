...
public class PMMLPlugin extends AbstractParameterizablePlugin {
	...
	public boolean run(Outline outline, Options options, ErrorHandler errorHandler){
		...
		for(ClassOutline clazz : clazzes){
			...
			if(checkType(beanClazz, "org.dmg.pmml.association.Item") || checkType(beanClazz, "org.dmg.pmml.association.Itemset") || checkType(beanClazz, "org.dmg.pmml.sequence.Sequence") || checkType(beanClazz, "org.dmg.pmml.TextDocument") || checkType(beanClazz, "org.dmg.pmml.support_vector_machine.VectorInstance")){
				JMethod keyMethod = beanClazz.method(JMod.PUBLIC, String.class, "getKey");
				keyMethod.annotate(Override.class);
