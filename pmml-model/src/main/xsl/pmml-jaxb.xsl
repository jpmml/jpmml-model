...
<xsl:stylesheet version="1.0" xmlns="http://www.dmg.org/PMML-4_3" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="xs:element[@name='CategoricalPredictor' or @name='NormDiscrete' or @name='PPCell' or @name='SimplePredicate' or @name='TargetValue' or @name='Value']/xs:complexType/xs:attribute[@name='value']/@type">
		<xsl:attribute name="type">xs:anySimpleType</xsl:attribute>
	</xsl:template>
